...
<div class="col-md-5  m-auto pt-1 pb-3">
	<form method="post"
		action="adminFeesTableController?edit_fee_type=formfillupfee&&page=<%out.println(pageNo);%>">
