...
<button id="cmd">Download receipt</button>
	...
	<div class="row" id="htmltopdf">
		<div class="box">
			...
			<h2>Barishal-8200</h2>
			<h3>Dept. of <%=stu.getS_department()%></h3>
			<h3>Receipt</h3>
			...
			<p>
				Student's Name :<%=stu.getS_name()%></p>
			<p>
				Mother's Name :<%=stu.getS_mother_name()%></p>
			<p>
				Father's Name :<%=stu.getS_father_name()%></p>
			<p>
				Department Name :<%=stu.getS_department()%></p>
			<p>
				Faculty Name :<%=stu.getS_faculty()%></p>
