...
@WebServlet("/restApiDevelopmentFeeController")
public class restApiDevelopmentFeeController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("restApiDevelopmentFeeController?rollno"+stu_roll);
	    ...
	    System.out.println("line no 58 in restApiDevelopmentFeeController ========> profile : "+id  +  roll  + reg + name  + fname  + mname  + sem  + dept+  fac);
	    
	    System.out.println("---------------------------");
	    
	    String changedamount = studentFetch.getChangedAmount(roll,sem);
	    System.out.println("changed amount is "+changedamount);
	    ...
	    if(!(id== null)) {
			...
			JSONObject profile = new JSONObject();
			    		try {	
					    	...
					    	String sql2 = "select * from admin_development_fees_table where semester = '"+sem+"' ";
					    	...
					    	while(myRs.next()) {
					    		...
					    		System.out.println("line no 91 in restApiDevelopmentFeeController  validity status =======>"+ rs);
					    		
					    		if(!(changedamount==null)) {
					    			
					    			int amount1 = Integer.parseInt(changedamount);
					    			int amount2 = Integer.parseInt(mise);
					    			
					    			if(amount2>=amount1) {
					    				profile.put("misce_fee",amount2-amount1);
					    			}else {
