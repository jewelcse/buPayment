...
/**
 * Servlet implementation class restApiFormfillupFeeController
 */
@WebServlet("/restApiFormfillupFeeController")
public class restApiFormfillupFeeController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	  ...
	  static checkValidity ck = new checkValidity();
		...
		protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			System.out.println("restApiFormfillupFeeController?rollno"+stu_roll);
		    ...
		    System.out.println("line no 58 in restApiFormfillupFeeController ========> profile : "+id  +  roll  + reg + name  + fname  + mname  + sem  + dept+  fac);
		    ...
		    if(!(id== null)) {
				...
				JSONObject profile = new JSONObject();
				    		try {	
						    	...
						    	String sql2 = "select * from admin_formfillup_fees_table where semester = '"+sem+"' ";
						    	...
						    	while(myRs.next()) {
						    		...
						    		System.out.println("line no 91 in restApiFormfillupFeeController  validity status =======>"+ rs);
